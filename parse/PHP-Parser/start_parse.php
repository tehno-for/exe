...
*************************************************************/
	...
	// SSL websites.
	$start_url = "https://furnitura.az/index.php?id_product=";
	...
	function GetUrl ($url) {
		$agent = "Mozilla/5.0 (compatible:" . VERSION . ")";
	...
	function Scan ($url) {
		global $start_url, $scanned, $pf, $extension, $skip;
