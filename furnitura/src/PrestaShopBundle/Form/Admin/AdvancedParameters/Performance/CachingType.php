        ...
        return [
            'CacheMemcache' => $this->trans('Memcached via PHP::Memcache', 'Admin.Advparameters.Feature')
                ...
                . $this->trans(
                    ...
                    [
                        '[a]' => '<a href="https://www.php.net/manual/en/memcache.installation.php" target="_blank">',
                        '[/a]' => '</a>',
                    ]
                ),
            'CacheMemcached' => $this->trans('Memcached via PHP::Memcached', 'Admin.Advparameters.Feature')
                ...
                . $this->trans(
                    ...
                    'Admin.Advparameters.Notification',
                    [
                        '[a]' => '<a href="https://www.php.net/manual/en/memcached.installation.php" target="_blank">',
                        '[/a]' => '</a>',
                    ]
                ),
            'CacheApc' => $this->trans('APC', 'Admin.Advparameters.Feature')
                ...
                . $this->trans(
                    ...
                    'Admin.Advparameters.Notification',
                    [
                        '[a]' => '<a href="https://www.php.net/manual/en/apc.installation.php" target="_blank">',
                        '[/a]' => '</a>',
                    ]
                ),
            'CacheXcache' => $this->trans('Xcache', 'Admin.Advparameters.Feature')
                ...
                . $this->trans(
                    ...
                    'Admin.Advparameters.Notification',
                    [
                        '[a]' => '<a href="https://xcache.lighttpd.net" target="_blank">',
                        '[/a]' => '</a>',
                    ]
                ),
        ];
