...
class MetaPageHelperDocLinkProvider implements HelperDocLinkProviderInterface
{
    ...
    {
        $link = 'https://doc.prestashop.com/display/PS17/SEO+and+URLs';

        switch ($this->contextIsoCode) {
            case 'fr':
                $link = 'https://doc.prestashop.com/display/PS17/SEO+et+URL';
                break;
            case 'es':
                $link = 'https://doc.prestashop.com/display/PS17/SEO+y+URLs';
                break;
            case 'it':
                $link = 'https://doc.prestashop.com/display/PS17/SEO+e+URL';
        }
