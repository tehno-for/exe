...
class WebserviceRequestCore
{
     ...
     * @var string
     */
    protected $_docUrl = 'https://doc.prestashop.com/display/PS16/Using+the+PrestaShop+Web+Service';
    ...
    */
    ...
    {
        if (is_array(self::$shopIDs) && count(self::$shopIDs)) { /* Userchange add is_array(self::$shopIDs) &&*/
            return true;
        }
