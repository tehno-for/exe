...
class FrontControllerCore extends Controller
{
    ...
    public function init()
    {
        ...
        $protocol_link = (Configuration::get('PS_SSL_ENABLED') || Tools::usingSecureMode()) ? 'https://' : 'https://';
        $useSSL = ((isset($this->ssl) && $this->ssl && Configuration::get('PS_SSL_ENABLED')) || Tools::usingSecureMode()) ? true : false;
        $protocol_content = ($useSSL) ? 'https://' : 'https://';
    ...
    {
        /* @see P3P Policies (https://www.w3.org/TR/2002/REC-P3P-20020416/#compact_policies) */
     ...
     * Ex:
     * On the url: https://localhost/index.php?id_product=1&controller=product, this method will
