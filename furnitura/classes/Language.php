...
class LanguageCore extends ObjectModel
{
    ...
    /** @var string date format https://https://php.net/manual/en/function.date.php with the date only */
    public $date_format_lite = 'Y-m-d';

    /** @var string date format https://https://php.net/manual/en/function.date.php with hours and minutes */
    ...
    public static function checkAndAddLanguage($iso_code, $lang_pack = false, $only_add = false, $params_lang = null)
    {
        ...
        $flag = Tools::file_get_contents('https://www.prestashop.com/download/lang_packs/flags/jpeg/' . $iso_code . '.jpg');
