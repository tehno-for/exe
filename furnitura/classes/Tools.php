...
class ToolsCore
{
    ...
    public static function redirect($url, $base_uri = __PS_BASE_URI__, Link $link = null, $headers = null)
    {
        ...
        if (strpos($url, 'https://') === false && strpos($url, 'https://') === false && $link) {
    ...
    public static function getShopProtocol()
    {
        $protocol = (Configuration::get('PS_SSL_ENABLED') || (!empty($_SERVER['HTTPS'])
            && Tools::strtolower($_SERVER['HTTPS']) != 'off')) ? 'https://' : 'https://';
    ...
    public static function getShopDomainSsl($http = false, $entities = false)
    {
        ...
        if ($http) {
            $domain = (Configuration::get('PS_SSL_ENABLED') ? 'https://' : 'https://') . $domain;
        }
    ...
    public static function replaceAccentedChars($str)
    {
        /* One source among others:
            https://www.tachyonsoft.com/uc0000.htm
            https://www.tachyonsoft.com/uc0001.htm
            https://www.tachyonsoft.com/uc0004.htm
        */
        $patterns = array(
            /* Lowercase */
    ...
    ** For other purposes use the smarty function instead */
     ...
     * @param bool $use_include_path second parameter of https://php.net/manual/en/function.file-get-contents.php
     * @param resource $stream_context third parameter of https://php.net/manual/en/function.file-get-contents.php
    ...
    public static function generateHtaccess($path = null, $rewrite_settings = null, $cache_control = null, $specific = '', $disable_multiviews = null, $medias = false, $disable_modsec = null)
    {
        ...
        if (file_exists($path)) {
            ...
            if (preg_match('#^(.*)\# ~~start~~.*\# ~~end~~[^\n]*(.*)$#s', $content, $m)) {
                ...
                if (preg_match('#\# https://www\.prestashop\.com - https://www\.prestashop\.com/forums\s*(.*)<IfModule mod_rewrite\.c>#si', $content, $m)) {
                    $specific_before = $m[1];
                } else {
...
<IfModule mod_deflate.c>
    ...
    public static function generateRobotsFile($executeHook = false)
    {
        ...
        if (file_exists($sitemap_file) && filesize($sitemap_file)) {
            ...
            fwrite($write_fd, 'Sitemap: ' . (Configuration::get('PS_SSL_ENABLED') ? 'https://' : 'https://') . $_SERVER['SERVER_NAME']
...
';
    ...
    /**
     * Fix native uasort see: https://php.net/manual/en/function.uasort.php#114535.
     *
     * @param $array
     * @param $cmp_function
     */
