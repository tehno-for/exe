...
/* Please do not use LC_ALL here https://www.php.net/manual/fr/function.setlocale.php#25041 */
...
$https_link = (Tools::usingSecureMode() && Configuration::get('PS_SSL_ENABLED')) ? 'https://' : 'https://';
