	...
	{	
		...
		$(window).scroll(function() {    
			...
			if (scroll >= headerSpaceH) {
				$(".use-sticky").parents(".header-top").addClass("scroll-menu").addClass(" animated fadeInDown");
			  $('.headerSpace').removeClass('unvisible');
			}else{
			  $(".use-sticky").parents(".header-top").removeClass("scroll-menu").removeClass("animated fadeInDown");
