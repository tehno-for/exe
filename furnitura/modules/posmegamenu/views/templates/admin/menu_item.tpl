	...
	<div class="form-wrapper" id="menuContent" >
		...
		<div class="form-group lab-fw-icon">
			...
			<div class="col-lg-9">
				...
				<p>{l s='Put class icon of Font-Awesome at :' mod='posmegamenu'} <a href="https://fortawesome.github.io/Font-Awesome/3.2.1/icons/">https://fortawesome.github.io/Font-Awesome/3.2.1/icons/.</a> ex: <span>&lt;i class="</span>fab fa-angellist<span>"&gt;&lt;/i&gt;</span></p> 
			</div>
		</div>
