...
{	
					...
					{	
						...
						switch ($sub_menu_info['type_link']) {
						    ...
						    case 5: // banner image
						        break;
						    case 6: // html
								$sub_menu_infos[$key1]['htmlcontent']= str_replace('/pos_optima2/',__PS_BASE_URI__,$sub_menu_infos[$key1]['htmlcontent']);
						        break;
						    case 7: // manufacturer
						        $sub_menu_infos[$key1]['manufacturer_logo'] = $this->context->link->getManufacturerImageLink((int)$sub_menu_info['id_manufacturer']);
						        $sub_menu_infos[$key1]['link'] = $this->context->link->getManufacturerLink((int)$sub_menu_info['id_manufacturer']);
	...
	{
		$this->context->controller->addJS($this->_path.'views/js/front.js'); #ttest del /
		$this->context->controller->addCSS($this->_path.'views/css/front.css'); #ttest del /
