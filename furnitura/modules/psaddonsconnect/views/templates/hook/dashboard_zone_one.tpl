		                    ...
		                    <div class="row">
		                        <div class="col-md-12">
		                            <p>
		                                ...
		                                <a href="https://addons.prestashop.com/authentication.php?utm_source=back-office&utm_medium=AddonsConnect&utm_campaign=back-office-{$currentLangIsoCode}&utm_content=signup" target="_blank">{l s='Sign up now' mod='psaddonsconnect'}</a>
		                            </p><br>
		                            ...
		                            <p>
		                                <a href="https://addons.prestashop.com/password.php?utm_source=back-office&utm_medium=AddonsConnect&utm_campaign=back-office-{$currentLangIsoCode}&utm_content=password" target="_blank">{l s='Forgot your password?' mod='psaddonsconnect'}</a>
		                            </p>
		                        </div>
		                    </div>
		                </div>
