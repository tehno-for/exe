...
* @license   https://addons.prestashop.com/en/content/12-terms-and-conditions-of-use
...
<div class="panel col-lg-10 right-panel">
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <a href="https://ec.europa.eu/justice/article-29/structure/data-protection-authorities/" target="_blank">
            <div class="col-lg-2">
        ...
        <a href="https://build.prestashop.com/news/prestashop-and-gdpr/" target="_blank">
            <div class="col-lg-2">
                <div class="psgdpr-card-useful-link">
