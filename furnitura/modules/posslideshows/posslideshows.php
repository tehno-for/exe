        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1">New New Arrivals</p>
					<p class="title2">Pendant Lighting</p>
					<p class="title3">Design pendant lighting beat light copper shade <span>Chandelier Lights</span></p>
					<p class="readmore"><a href="#"><span><i class="fa fa-plus"></i> Shop Now</span></a></p>
					</div>';
				}elseif($i==2){
					$slide->description[$language['id_lang']] = '<div class="info desc1">
					<p class="title1">Best Selling</p>
					<p class="title2">Dinning Chairs</p>
					<p class="title3">Give your dining room a wondrous and inviting look<span>by introducing depp blues</span></p>
					<p class="readmore"><a href="#"><span><i class="fa fa-plus"></i> Shop Now</span></a></p>
					</div>';
				}
                ...
                $slide->url[$language['id_lang']] = 'https://www.posthemes.com';
