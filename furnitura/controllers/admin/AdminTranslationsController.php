...
class AdminTranslationsControllerCore extends AdminController
{
    ...
    protected $link_lang_pack = 'https://i18n.prestashop.com/translations/%ps_version%/available_languages.json';
    ...
    protected function getMailPattern()
    {
        ...
        return '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "https://www.w3.org/TR/1999/REC-html401-19991224/strict.dtd">
<html>
<head>
