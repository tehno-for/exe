        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'html_content' => '<div id="employee-thumbnail"><a href="https://www.prestashop.com/forums/index.php?app=core&amp;module=usercp" target="_blank" style="background-image:url(' . $obj->getImage() . ')"></a></div>
					<div id="employee-avatar-thumbnail" class="alert alert-info">' . $this->trans(
                        ...
                        array(
                            '%url%' => '<a href="https://www.prestashop.com/forums/index.php?app=core&amp;module=usercp" class="alert-link" target="_blank">PrestaShop.com</a>',
                            '%email%' => $obj->email,
                        ),
