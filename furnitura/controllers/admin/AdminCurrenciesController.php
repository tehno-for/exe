...
class AdminCurrenciesControllerCore extends AdminController
{
    ...
    public function ajaxProcessCronjobLiveExchangeRate()
    {
        ...
        $cronJobUrl = 'https://' . ShopUrl::getMainShopDomain($this->context->shop->id) . __PS_BASE_URI__ . basename(_PS_ADMIN_DIR_) . '/cron_currency_rates.php?secure_key=' . md5(_COOKIE_KEY_ . Configuration::get('PS_SHOP_NAME'));
