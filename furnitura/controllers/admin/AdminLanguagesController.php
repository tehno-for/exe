...
class AdminLanguagesControllerCore extends AdminController
{
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    /*'desc' => $this->trans('IETF language tag (e.g. en-US, pt-BR).').' '.sprintf('<a href="https://en.wikipedia.org/wiki/IETF_language_tag" target="_blank">%s <img src="../img/admin/external_link.png" class="icon-top" /></a>', $this->l('IETF on Wikipedia'))*/
                ),
                array(
                    'type' => 'text',
                    ...
                    /* TO DO - ajouter les liens dans le hint ? */
                    /*'desc' => sprintf($this->trans('Short date format (e.g., %s)'), '<a href="https://php.net/date" target="_blank">Y-m-d</a>')*/
                ),
                array(
                    'type' => 'text',
                    ...
                    /* TO DO - ajouter les liens dans le hint ? */
                    /*'desc' => sprintf($this->trans('Full date format (e.g., %s)'), '<a href="https://php.net/date" target="_blank">Y-m-d H:i:s</a>')*/
                ),
                array(
                    'type' => 'file',
    ...
    public function ajaxProcessCheckLangPack()
    {
        ...
        if ($lang_packs = Tools::file_get_contents('https://www.prestashop.com/download/lang_packs/get_language_pack.php?version=' . Tools::getValue('ps_version') . '&iso_lang=' . Tools::strtolower(Tools::getValue('iso_lang')))) {
