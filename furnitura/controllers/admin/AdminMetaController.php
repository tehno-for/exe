...
class AdminMetaControllerCore extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $robots_description = $this->trans('Your robots.txt file MUST be in your website\'s root directory and nowhere else (e.g. https://www.example.com/robots.txt).', array(), 'Admin.Shopparameters.Notification');
        ...
        $this->fields_form = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'hint' => array(
                        $this->trans('For instance, "contacts" for https://example.com/shop/contacts to redirect to https://example.com/shop/contact-form.php', array(), 'Admin.Shopparameters.Help'),
