...
class SymfonyRequirements extends RequirementCollection
{
    ...
    public function __construct()
    {
        ...
        $this->addRequirement(
            ...
            'Vendor libraries are missing. Install composer following instructions from <a href="https://getcomposer.org/">https://getcomposer.org/</a>. '.
        ...
        if (false !== $requiredPhpVersion && version_compare($installedPhpVersion, $requiredPhpVersion, '>=')) {
            $this->addRequirement(
                ...
                'Your default timezone is not supported by PHP. Check for typos in your <strong>php.ini</strong> file and have a look at the list of deprecated timezones at <a href="https://php.net/manual/en/timezones.others.php">https://php.net/manual/en/timezones.others.php</a>.'
            );
        }
