...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('EoqLoRBCQl', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'c1furnitura_DB', 'user' => 'c1prestauser', 'password' => 'VkPe8Q6Voz#kL', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_4a9fdc5591c59d3ae6730b923cf096e09b05c5510340c02f8004d660aa60e728');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Qcfu22afwhgiqxwXtOkHoGXQotqsYrUq5DEmVhc32tbCpwE0bgwVdiHJ'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('Qcfu22afwhgiqxwXtOkHoGXQotqsYrUq5DEmVhc32tbCpwE0bgwVdiHJ');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                77 => 'ps_featuredproducts',
                78 => 'xipblogdisplayposts',
                79 => 'medgtranslate',
                80 => 'posspecialproducts',
            ],
            'container.autowiring.strict_mode' => true,
            'container.dumper.inline_class_loader' => false,
            'database_host' => '127.0.0.1',
            'database_port' => '',
            'database_name' => 'c1furnitura_DB',
            'database_user' => 'c1prestauser',
            'database_password' => 'VkPe8Q6Voz#kL',
            'database_prefix' => 'ps_',
            ...
            'secret' => 'Qcfu22afwhgiqxwXtOkHoGXQotqsYrUq5DEmVhc32tbCpwE0bgwVdiHJ',
            'ps_caching' => 'CacheMemcached',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-12-02',
            'locale' => 'en-US',
            'cookie_key' => '4IvUu2uCIvfsZVXhFLb3ULi33d84i8WQC7v72te8zfG6OmcMC5ScIu7L',
            'cookie_iv' => 'iZi5By0G',
            'new_cookie_key' => 'def000003aa666b660ae6365192c4d28831355f0e89c01738025e4b56fabf7dd8ea1b2451d9f8e61c0474dec559788eef47e571689ea2001dcbf9d94ef3c52fe3dedf882',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => 'Qcfu22afwhgiqxwXtOkHoGXQotqsYrUq5DEmVhc32tbCpwE0bgwVdiHJ',
