...
function display(view)
{
	if (view == 'grid')
	{
		...
		$('.product_content .item-product').each(function(index, element) {
			...
			html += '<article class="js-product-miniature item_in" data-id-product="'+ id_product +'" data-id-product-attribute="'+ id_product_attr +'" itemscope itemtype="https://schema.org/Product">';
	...
	{	
		...
		$('.product_content .item-product').each(function(index, element) {
			...
			var id_product = $(this).children('article.js-product-miniature').attr('data-id-product');
			var id_product_attr = $(this).children('article.js-product-miniature').attr('data-id-product-attribute');
			html = '<article class="js-product-miniature item_in" data-id-product="'+ id_product +'" data-id-product-attribute="'+ id_product_attr +'" itemscope itemtype="https://schema.org/Product"><div class="row">';
