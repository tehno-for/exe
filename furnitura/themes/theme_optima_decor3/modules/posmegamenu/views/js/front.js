	...
	{	
		...
		$(window).scroll(function() {    
			...
			if (scroll >= headerSpaceH) {
				$(".use-sticky").parents(".header-bottom").addClass("scroll-menu").addClass(" animated fadeInDown");
			  $('.headerSpace').removeClass('unvisible');
			}else{
			  $(".use-sticky").parents(".header-bottom").removeClass("scroll-menu").removeClass("animated fadeInDown");
