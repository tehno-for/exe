...
define('lang_Upload_java_help', "Om Java Appleten inte laddar, 1. säkerställ att Java är installerat, <a href='https://java.com/en/download/'>ladda hem</a> och installera om det saknas  2. säkerställ att programmet inte blokeras av din brandvägg"); // If the Java Applet doesn't load, 1. make sure you have Java installed, otherwise <a href='https://java.com/en/download/'>[download link]</a>   2. make sure nothing is blocked by your firewall
