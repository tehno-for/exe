...
define('lang_Upload_java_help', "Si el applet no carga: 1. Asegúrate de tener Java instalado; sino descárgalo e instálalo <a href='https://java.com/en/download/'>desde aquí</a> 2. Asegúrate que tu firewall no esté bloqueando nada.");
