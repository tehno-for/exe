...
/* Code verified using https://www.jshint.com/ */
			...
			jPlayerInit = function() {
				(function($) {
					...
					myPlayer.bind($.jPlayer.event.error, function(event) {
						// Not sure how to handle the error situation. Popcorn does not appear to have the error or error.code property documented here: https://popcornjs.org/popcorn-docs/media-methods/
