			...
			<div id="tracking_help" style="display: none;">
				...
				<ul>
					<li>
						...
						{l s='For example, visitors coming from Google will have an "http_referer" value like this one: "https://www.google.com/search?q=prestashop".' d='Admin.Shopparameters.Help'}<br />
					...
					<li>
						...
						<a class="btn btn-link _blank" href="https://dev.mysql.com/doc/refman/5.0/en/regexp.html" style="font-style: italic;"><i class="icon-external-link-sign"></i> {l s='Take a look at MySQL\'s documentation for more details.' d='Admin.Shopparameters.Help'}</a>
					</li>
				</ul>
			</div>
		</div>
