			...
			<div class="alert alert-info">
				<ul class="list-unstyled">
					<li>{l s='You can read information on import at:' d='Admin.Advparameters.Help'}
						<a href="{l s='https://doc.prestashop.com/display/PS17/Import' d='Admin.Advparameters.Help'}" class="_blank">{l s='https://doc.prestashop.com/display/PS17/Import' d='Admin.Advparameters.Help'}</a>
					</li>
