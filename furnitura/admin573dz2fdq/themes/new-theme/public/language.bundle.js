...
$(document).ready(function () {
  var languageGrid = new __WEBPACK_IMPORTED_MODULE_0__components_grid_grid__["a" /* default */]('language');

  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_1__components_grid_extension_reload_list_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_2__components_grid_extension_export_to_sql_manager_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_3__components_grid_extension_filters_reset_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_4__components_grid_extension_sorting_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_5__components_grid_extension_link_row_action_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_6__components_grid_extension_submit_bulk_action_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_7__components_grid_extension_action_row_submit_row_action_extension__["a" /* default */]());
  languageGrid.addExtension(new __WEBPACK_IMPORTED_MODULE_8__components_grid_extension_bulk_action_checkbox_extension__["a" /* default */]());
});
