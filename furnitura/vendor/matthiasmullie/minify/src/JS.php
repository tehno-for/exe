 ...
 * JavaScript minifier
 *
 * Please report bugs on http://github.com/matthiasmullie/minify/issues
 *
...
class JS extends Minify
{
     ...
     *
     * @see http://mathiasbynens.be/notes/reserved-keywords
     *
     * @var string[]
     */
     ...
     *
     * @see http://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_Operators
     *
     * @var string[]
     */
    ...
    protected function extractRegex()
    {
        ...
        $propertiesAndMethods = array(
            // http://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp#Properties_2
            'constructor',
            'flags',
            'global',
            'ignoreCase',
            ...
            'sticky',
            'unicode',
            // http://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp#Methods_2
            'compile(',
            'exec(',
            'test(',
            'toSource(',
        ...
        // (http://github.com/matthiasmullie/minify/issues/56)
    ...
    protected function stripWhitespace($content)
    {
         ...
         *
         * @see http://github.com/matthiasmullie/minify/issues/91
         */
