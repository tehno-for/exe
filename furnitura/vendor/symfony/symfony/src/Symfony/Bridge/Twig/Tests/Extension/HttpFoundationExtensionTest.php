...
class HttpFoundationExtensionTest extends TestCase
{
    ...
    public function getGenerateAbsoluteUrlRequestContextData()
    {
        return [
            ...
            ['/foo.png', '/foo', 'localhost', 'https', 80, 443, 'http://localhost/foo.png'],
            ['foo.png', '/foo', 'localhost', 'https', 80, 443, 'http://localhost/foo/foo.png'],
            ['foo.png', '/foo/bar/', 'localhost', 'https', 80, 443, 'http://localhost/foo/bar/foo.png'],
            ['/foo.png', '/foo', 'localhost', 'http', 443, 80, 'http://localhost:443/foo.png'],
            ['/foo.png', '/foo', 'localhost', 'https', 443, 80, 'http://localhost:80/foo.png'],
        ];
    }
