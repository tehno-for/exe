...
HTML;
    ...
    public function getBaseTagData()
    {
        return [
            ...
            ['//base.com', 'link', 'http://base.com/link', 'http://domain.com', '<base> tag can use a schema-less URL'],
            ['path/', 'link', 'http://domain.com/path/link', 'http://domain.com', '<base> tag can set a path'],
    ...
    {
        return [
            ['http://base.com/', 'link/', 'http://base.com/link/', 'http://base.com/link/', '<base> tag does work with a path and relative form action'],
