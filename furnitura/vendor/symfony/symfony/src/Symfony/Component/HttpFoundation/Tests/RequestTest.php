...
class RequestTest extends TestCase
{
    ...
    public function testCreateWithRequestUri()
    {
        ...
        $request = Request::create('http://test.com:443/foo');
        $request->server->set('REQUEST_URI', 'http://test.com:443/foo');
        $this->assertEquals('http://test.com/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('test.com', $request->getHost());
        $this->assertEquals('test.com', $request->getHttpHost());
    ...
    public function getRequestUriData()
    {
        ...
        yield ['http://test.com:8080/foo', '/foo', $message];
        yield ['http://test.com:443/foo', '/foo', $message];
