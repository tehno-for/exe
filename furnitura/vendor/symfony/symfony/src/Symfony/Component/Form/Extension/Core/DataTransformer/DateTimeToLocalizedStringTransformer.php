...
class DateTimeToLocalizedStringTransformer extends BaseDateTimeTransformer
{
    ...
    protected function getIntlDateFormatter($ignoreTimezone = false)
    {
        ...
        if (class_exists('IntlTimeZone', false)) {
            // see http://bugs.php.net/bug.php?id=66323
        ...
        // new \intlDateFormatter may return null instead of false in case of failure, see http://bugs.php.net/bug.php?id=66323
