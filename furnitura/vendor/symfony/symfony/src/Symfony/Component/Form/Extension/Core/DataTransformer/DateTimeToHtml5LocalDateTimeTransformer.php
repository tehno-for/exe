...
class DateTimeToHtml5LocalDateTimeTransformer extends BaseDateTimeTransformer
{
     ...
     * http://html.spec.whatwg.org/multipage/common-microsyntaxes.html#valid-local-date-and-time-string
     *
     ...
     * http://html.spec.whatwg.org/multipage/common-microsyntaxes.html#parse-a-local-date-and-time-string
     *
    ...
    public function reverseTransform($dateTimeLocal)
    {
        ...
        // see http://github.com/symfony/symfony/issues/28699
