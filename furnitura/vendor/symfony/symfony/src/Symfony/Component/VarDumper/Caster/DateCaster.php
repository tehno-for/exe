...
class DateCaster
{
    ...
    {
        if (\defined('HHVM_VERSION_ID') || \PHP_VERSION_ID < 50620 || (\PHP_VERSION_ID >= 70000 && \PHP_VERSION_ID < 70005)) { // see http://bugs.php.net/bug.php?id=71635
            return $a;
        }

        $dates = [];
        if (\PHP_VERSION_ID >= 70107) { // see http://bugs.php.net/bug.php?id=74639
