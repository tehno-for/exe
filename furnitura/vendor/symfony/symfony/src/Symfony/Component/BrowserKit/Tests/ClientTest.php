...
class ClientTest extends TestCase
{
    ...
    {
        $client = new TestClient();
        $client->request('GET', 'http://example.com/foo', [], [], ['HTTP_HOST' => '127.0.0.1']);

        $this->assertEquals('http://example.com/foo', $client->getRequest()->getUri());
    ...
    public function testFollowRedirectWithMaxRedirects()
    {
        ...
        $this->assertEquals('http://www.example.org/', $client->getRequest()->getUri(), '->followRedirect() follows protocol-relative URLs');
    ...
    public function testSetServerParameterInRequest()
    {
        ...
        $client->request('GET', 'http://www.example.com/https/www.example.com', [], [], [
            'HTTP_HOST' => 'testhost',
    ...
    public function testRequestWithRelativeUri()
    {
        ...
        $this->assertEquals('http://testhost/', $client->getRequest()->getUri());

        $client->request('GET', 'http://www.example.com/', [], [], [
            'HTTP_HOST' => 'testhost',
            'HTTPS' => false,
        ]);
        $this->assertEquals('http://www.example.com/', $client->getRequest()->getUri());
    }
