...
class UrlGeneratorTest extends TestCase
{
    ...
    {
        $routes = $this->getRoutes('test', new Route('/', [], [], [], '', ['https']));
        $this->assertEquals('http://localhost/app.php/', $this->getGenerator($routes)->generate('test'));
    ...
    public function testGenerateRelativePath()
    {
        ...
        $this->assertSame('http://example.com/app.php/bernhard/blog', $generator->generate('scheme',
