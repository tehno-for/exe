...
class OpenSSL extends \RandomLib\AbstractSource
{
    ...
    {
        /**
         * Prior to PHP 5.6.12 (see http://bugs.php.net/bug.php?id=70014) the "openssl_random_pseudo_bytes"
        ...
        /**
         * Prior to PHP 5.5.28 (see http://bugs.php.net/bug.php?id=70014) the "openssl_random_pseudo_bytes"
         * was using "RAND_pseudo_bytes" (predictable) instead of "RAND_bytes" (unpredictable).
        ...
        /**
         * Prior to PHP 5.4.44 (see http://bugs.php.net/bug.php?id=70014) the "openssl_random_pseudo_bytes"
         * was using "RAND_pseudo_bytes" (predictable) instead of "RAND_bytes" (unpredictable).
