 ...
 * http://php.net/manual/curl.setup.php
 *
 ...
 * ```
 *
 * @see http://php.net/manual/curl.setup.php
 */
class Curl
{
     ...
     */
    const USER_AGENT = 'PHP Curl/1.9 (+http://github.com/php-mod/curl)';
    ...
    public function __construct()
    {
        if (!extension_loaded('curl')) {
            throw new \ErrorException('The cURL extensions is not loaded, make sure you have installed the cURL extension: http://php.net/manual/curl.setup.php');
        }
